...
gsap.to("#img",{
  scrollTrigger:{
    ...
    onEnterBack:()=>{
      ...
      document.querySelector("#c").textContent="Lorem ipsum dolor sit, amet elit. Eius, Lorem ipsum dolor sit ametLorem, ipsum.";
...
gsap.to("#img4",{
  scrollTrigger:{
    ...
    onEnter:()=>{
      ...
      document.querySelector("#c").textContent="Hotel And Restaurant app for IOS,which allows to save your Favourite Food";
...
gsap.to("#img8",{
  scrollTrigger:{
    ...
    onEnter:()=>{
      ...
      document.querySelector("#c").textContent="An android app, which allows users to Plan and maintain schedule according to daily needs";
      t.forEach(function(elem){
        elem.restart(true);
      })
    },
...
gsap.to("#img10",{
  scrollTrigger:{
    ...
    onEnter:()=>{
      ...
      document.querySelector("#c").textContent="Automate your work by controlling tech in your car using your mobilephone";
      t.forEach(function(elem){
        elem.restart(true);
      })
    },
